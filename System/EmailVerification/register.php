    ...
    if ($password == $cpassword) {
        ...
        if (!$result->num_rows > 0) {
            ...
            try {
                ...
                $sql = "INSERT INTO tbl_users(first_name,last_name, email, login, verification_code, email_verified_at) VALUES ('" . $firstname . "','" . $lastname . "', '" . $email . "', '" . $encrypted_password . "', '" . $verification_code . "', NULL)";
