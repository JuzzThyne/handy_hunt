...
<head>
	...
	<title>Handy Hunt - Contact Us</title>
					...
					<div class="row">
						...
						<div class="col-sm-5 col-md-4">
							...
							<ul class="address-list">
								<li>
									<h5>Address</h5>
									<address> University of Caloocan City, <br /> Congressional Campus, <br />Caloocan City</address>
								</li>
								<li>
									<h5>Email</h5><a href="mailto:nightingale.nath2@gmail.com">handyhunt@gmail.com</a>
								</li>
								<li>
									<h5>Phone Number</h5><a href="tel:+233 546 607 474">09101493778</a>
								</li>
