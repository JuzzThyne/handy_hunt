			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="../">Jobs</a></li>
						<li><span>Educational Attainment</span></li>
					</ol>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-3_sm-4_xs-12">
								...
								<div class="admin-sidebar">
									...
									<div class="admin-user-action text-center">
										...
										<a  href="my_cv" class="btn btn-primary btn-sm btn-inverse">View my CV</a>
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
											...
											<div class="row">
												...
												<div class="col-sm-12 col-md-10">
													...
													<div class="content">
														...
														<a   href="view-certificate.php?id=<?php echo $row['id']; ?>" >
									...
									<a href="app/drop-qualification.php?id=<?php echo $row['id']; ?>" onclick = "return confirm('Are you sure you want to delete this Educational Attainment ?')" class="btn btn-primary btn-sm btn-inverse">Delete</a>
									...
									<option disabled value="">Select</option>
										...
										<option <?php if ($ccountry == $row['city_name'] ) { print ' selected '; } ?> value="<?php echo $row['city_name']; ?>"><?php echo $row['city_name']; ?></option>
										<?php
	                                     }
                                         $stmt->execute();
								    ...
								    <input class="form-control" value="<?php echo "$institution"; ?>" placeholder="Enter School name" type="text" name="institution" required> 
							        </div>
								...
								?>
							        ...
							        <div class="form-group"> 
								    <label>School Name</label>
								    <input class="form-control" placeholder="Enter School name" type="text" name="institution" required> 
							        </div>
								...
								<div class="row">
									...
									<div class="col-sm-6 col-md-4">
										...
										<div class="footer-about-us">
											...
											<p>Jobs is a job portal, online job management system.</p>
