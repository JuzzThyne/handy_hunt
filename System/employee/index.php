						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="container">
									...
									<h2>Status</h2>
										<div class="progress">
										<div class="<?php echo $stat_color ?>" role="progressbar" aria-valuenow="50" aria-valuemin="0" aria-valuemax="100" style="width:100%">
										<?php echo $work_stat ?>
										</div>
									</div>
								</div>		
												...
												<div class="col-sm-6 col-md-4">
													...
													<div class="form-group">
														...
														<select name="country" required class="selectpicker show-tick form-control" data-live-search="true">
                                                           ...
                                                           {
		                                                    ?> <option <?php if ($mycountry == $row['city_name']) { print ' selected '; } ?> value="<?php echo $row['city_name']; ?>"><?php echo $row['city_name']; ?></option> <?php
