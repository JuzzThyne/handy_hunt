...
<head>
	...
	<title>Handy Hunt - Academic Qualifications</title>
						...
						<div class="GridLex-grid-noGutter-equalHeight">
							...
							<div class="GridLex-col-9_sm-8_xs-12">
								...
								<div class="admin-content-wrapper">
									...
									<option disabled value="">Select</option>
						            <?php
									$stmtb = $conn->prepare("SELECT * FROM tbl_city ORDER BY city_name");
                                    $stmtb->execute();
                                    ...
                                    {
										?>
										<option <?php if ($ccountry == $rowb['city_name']) { print ' selected '; } ?> value="<?php echo $rowb['city_name']; ?>"><?php echo $rowb['city_name']; ?></option>
										<?php
