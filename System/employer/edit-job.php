												...
												<div class="col-sm-4 col-md-4">
													...
													<div class="form-group">
														...
														<select name="country" required class="selectpicker show-tick form-control" data-live-search="true">
                                                           ...
                                                           foreach($result as $row)
                                                           {
		                                                    ?> <option <?php if ($jobcountry == $row['city_name']) { print ' selected '; } ?> value="<?php echo $row['city_name']; ?>"><?php echo $row['city_name']; ?></option> <?php
					...
					<div class="container">
						...
						<div class="row">
							...
							<div class="col-sm-4 col-md-4">
								...
								<p class="copy-right">&#169; Copyright <?php echo date('Y'); ?> HandyHunt</p>
