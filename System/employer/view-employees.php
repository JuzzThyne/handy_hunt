...
<head>
	...
	<title>Handy Hunt - Applicants for the job <?php echo "$job_title"; ?></title>
			...
			<div class="breadcrumb-wrapper">
				...
				<div class="container">
					...
					<ol class="breadcrumb-list booking-step">
						<li><a href="./">Home</a></li>
						<li><span>Accepted Employees for the job <?php echo "$job_title"; ?></</span></li>
					</ol>
				...
				<div class="container">
					...
					<div class="sorting-wrappper">
						...
						<div class="sorting-header">
							<h3 class="sorting-title">Accepted Employees for the job <?php echo "$job_title"; ?></</h3>
						</div>
					...
					<div class="employee-grid-wrapper">
						...
						<div class="GridLex-gap-15-wrappper">
							...
							$stmtb = $conn->prepare("SELECT * FROM tbl_users WHERE role = 'employee' AND member_no = '$emp_id' AND status = 'hired'");
                            $stmtb->execute();
							...
							
							{
								...
								?>
									...
									<div class="employee-grid-item">
										...
										{
											$stmtb = $conn->prepare("UPDATE tbl_users SET status = 'unemployed' WHERE role = 'employee' AND member_no = '$emp_id'");
                            				$stmtb->execute();	
											$stmtba = $conn->prepare("DELETE FROM tbl_job_applications WHERE job_id = '$job_id' AND member_no = '$emp_id'");
                            				$stmtba->execute();
										...
										<button type="submit" name="submit" class="btn btn-primary btn-sm btn-inverse"> DONE WORKING </button>
										</form>
